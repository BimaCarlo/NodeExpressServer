...
var DBConnection = function () {
  ...
  this.Model = mongoose.model('users', this.Schema, 'users');//*? quali sono i valori dei parametri
  //*! il primo parametro definisce il nome del model, il secondo lo schema, il terzo la collection
}
